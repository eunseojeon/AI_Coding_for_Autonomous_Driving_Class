...
## 1. NumPy 배열 생성
- [Numpy 배열 생성](./0702_NumPy_배열_생성.ipynb) **<- 실습**
...
- [The Difference Between Copy and View](./0702_The_Difference_Between_Copy_and_View.ipynb) **<- 실습**

## 6. NumPy의 여러 배열에 대해서
- [Numpy의 여러 배열](./0702_NumPy의_여러_배열.ipynb) **<- 실습**
1. NumPy 배열 모양
