...
---
✅ **샤프닝**이란 이미지의 경계와 세부 정보를 더욱 선명하게 만드는 처리 방식으로, CNN에서도 중요한 이미지 변환 기법 중 하나입니다.
- 샤프닝은 이미지의 윤곽선, 경계, 작은 디테일을 강조하여 더 뚜렷하게 보이도록 하는 처리 방법입니다.
- 샤프닝 필터는 고주파 통과 필터로, 이미지 내에서 급격한 밝기 변화(엣지 등)를 강조하고, 흐릿함을 줄여줍니다
- 샤프닝 필터는 일반적으로 합성곱(Convolution) 연산을 통해 이미지에 적용됩니다.
- 대표적인 3x3 샤프닝 커널 예시:
```
0  -1   0
-1  5  -1
...
- 장점: 이미지의 디테일과 경계를 강조하여, 객체 인식이나 분할 등에서 유용하게 사용됩니다.
- 단점: 과도한 샤프닝은 노이즈까지 함께 강조시켜 이미지 품질을 저하시킬 수 있습니다.

<img width="784" height="615" alt="스크린샷 2025-07-14 11 14 58" src="https://github.com/user-attachments/assets/214dca4c-df1b-4f87-b14c-24c3bc5055a9" />
